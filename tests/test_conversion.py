...
class TestConversion(unittest.TestCase):
    ...
    def test_punctuation(self):
        ...
        self.assertEqual(conversion.punct_ipa('"Wow, that\'s amazing!!", she exclaimed.'),
                         '"waʊ, ðæts əˈmezɪŋ!!", ʃi ɪkˈsklemd.')
    ...
    def test_ipa_list(self):
        self.assertEqual(conversion.ipa_list('This is a test phrase.'), [['ðɪs'], ['ɪz'], ['e', 'ə'], ['tɛst'], ['frez']])
    ...
    def test_convert(self):
        ...
        self.assertEqual(conversion.convert('The quick brown fox jumped over the lazy dog.', retrieve_all=True),
